...
public class Warehouse{
	public MineTable getTable(int num){
		...
		table[2][1] = new MineTable(4, 4, new int[][] {{3 , 1}, {10, 0}, {2 , 2}, {1 , 1}, {10, 0}, {4 , 3}, {4 , 3}, {2 , 2}, {2 , 2}, {4 , 3}, {5 , 3}, {10, 0}, {10, 0}, {10, 0}, {3 , 1}, {2 , 1}});
		...
		table[3][0] = new MineTable(5, 5, new int[][] {{1 , 3}, {10, 0}, {1 , 3}, {10, 0}, {2 , 2}, {10, 0}, {3 , 2}, {10, 0}, {4 , 1}, {10, 0}, {2 , 1}, {4 , 3}, {10, 0}, {10, 0}, {2 , 3}, {3 , 1}, {10, 0}, {10, 0}, {10, 0}, {10, 0}, {1 , 2}, {10, 0}, {10, 0}, {3 , 2}, {1 , 1}}); 
